...
int main() {
    ...
    check_value(is_palindrome("t&DLNjqDWxmmxWDqjNLDt&"), false);
    ...
    int arr11_1[]={0, 0}, arr11_2[]={-1};
    merge_arrays(arr11_1, 1, arr11_2, 1);
    check_array(arr11_1, {-1, 0}, sizeof(arr11_1)/sizeof(int));
    ...
    int bills10[] = {10};
    check_value(bibimbap_change(bills10, sizeof(bills10)/sizeof(int)), false);
    int bills11[] = {20};
    check_value(bibimbap_change(bills11, sizeof(bills11)/sizeof(int)), false);
    int bills12[] = {5};
    check_value(bibimbap_change(bills12, sizeof(bills12)/sizeof(int)), true);
    int bills13[] = {5, 5, 5, 10, 20};
    check_value(bibimbap_change(bills13, sizeof(bills13)/sizeof(int)), true);
    return 0;
}